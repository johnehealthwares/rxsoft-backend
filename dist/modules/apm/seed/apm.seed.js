...
var ApmSeedService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ApmSeedService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const entities_1 = require("../entities");
let ApmSeedService = ApmSeedService_1 = class ApmSeedService {
    campaignInfoRepo;
    agendaRepo;
    achievementRepo;
    newsRepo;
    ...
    incidentRepo;
    gotvRepo;
    logger = new common_1.Logger(ApmSeedService_1.name);
    constructor(campaignInfoRepo, agendaRepo, achievementRepo, newsRepo, eventRepo, testimonialRepo, mediaRepo, lgaRepo, wardRepo, puRepo, stakeholderRepo, scoreRepo, waGroupRepo, agentRepo, resultRepo, incidentRepo, gotvRepo) {
...
exports.ApmSeedService = ApmSeedService;
exports.ApmSeedService = ApmSeedService = ApmSeedService_1 = __decorate([
    ...
    __param(5, (0, typeorm_1.InjectRepository)(entities_1.TestimonialOrmEntity)),
    __param(6, (0, typeorm_1.InjectRepository)(entities_1.MediaAssetOrmEntity)),
    __param(7, (0, typeorm_1.InjectRepository)(entities_1.LgaOrmEntity)),
    __param(8, (0, typeorm_1.InjectRepository)(entities_1.WardOrmEntity)),
    __param(9, (0, typeorm_1.InjectRepository)(entities_1.PollingUnitOrmEntity)),
    __param(10, (0, typeorm_1.InjectRepository)(entities_1.StakeholderOrmEntity)),
    __param(11, (0, typeorm_1.InjectRepository)(entities_1.ConversionScoreOrmEntity)),
    __param(12, (0, typeorm_1.InjectRepository)(entities_1.WhatsAppGroupOrmEntity)),
    __param(13, (0, typeorm_1.InjectRepository)(entities_1.PollingAgentOrmEntity)),
    __param(14, (0, typeorm_1.InjectRepository)(entities_1.ResultEntryOrmEntity)),
    __param(15, (0, typeorm_1.InjectRepository)(entities_1.IncidentReportOrmEntity)),
    __param(16, (0, typeorm_1.InjectRepository)(entities_1.GotvRecordOrmEntity)),
...
//# sourceMappingURL=apm.seed.js.map