...
let AuditService = class AuditService {
    ...
    async list(query) {
        const qb = this.auditLogRepository
            ...
            .where('audit.organization_id = :organizationId', { organizationId: persistence_scope_1.DEFAULT_ORGANIZATION_ID });
        if (query.search) {
...
exports.AuditService = AuditService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(entities_1.AuditLogOrmEntity)),
