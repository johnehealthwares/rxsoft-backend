...
let UpdateRoleUseCase = class UpdateRoleUseCase {
    ...
    async execute(id, payload, organizationId) {
        ...
        const updated = new role_entity_1.Role(id, organizationId, code, payload.name ?? existing.name, payload.description !== undefined ? payload.description : existing.description, payload.permissionCodes ?? existing.permissionCodes);
