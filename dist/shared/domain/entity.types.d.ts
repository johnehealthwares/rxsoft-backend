...
type EntityIdRef<T> = T extends {
    id: infer TId extends string;
} ? {
    id: TId;
} : never;
type SerializeEntityValue<T> = T extends Date ? string : T extends Date | null ? string | null : T extends Array<infer TItem> ? Array<EntityIdRef<TItem>> : T extends object | null ? EntityIdRef<NonNullable<T>> | null : T;
