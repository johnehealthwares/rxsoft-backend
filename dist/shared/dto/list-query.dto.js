...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Generic filter string' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], ListQueryDto.prototype, "filter", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Filter by organization (superadmin only)' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], ListQueryDto.prototype, "organizationId", void 0);
