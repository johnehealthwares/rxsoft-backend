# Graph Report - rxsoft  (2026-08-20)

## Corpus Check
- 814 files · ~5,438,021 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8292 nodes · 23298 edges · 286 communities (225 shown, 61 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 1121 edges (avg confidence: 0.64)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `43c431c6`
...
1. `RequestUser` - 198 edges
2. `CurrentUser` - 187 edges
...
- `FaqPage()` --indirect_call--> `WebsiteLayout()`  [INFERRED]
  public/assets/faq-CPcPqChv.js → public/assets/index-DuM1cidb.js
- `tweenRemove()` --indirect_call--> `i()`  [INFERRED]
  public/assets/flow-graph-Dwih7ASd.js → public/assets/index-DuM1cidb.js
- `fitView()` --references--> `transform`  [EXTRACTED]
  public/assets/flow-graph-Dwih7ASd.js → package.json

## Import Cycles
- None detected.

## Communities (286 total, 61 thin omitted)

### Community 0 - "URL Parameter Normalization"
Cohesion: 0.01
Nodes (261): RFC-3986, RFC-5322, RFC-9562, clearTokens(), decodeUserFromAccessToken(), getAccessToken(), getRefreshToken(), persistTokens() (+253 more)

### Community 1 - "UI Component Library"
Cohesion: 0.02
Nodes (221): AccordionChevron(), AppShellMediaStyles(), getPaddingValue(), useResizing(), getInitialsColor(), hashCode(), borderResolver(), _Box() (+213 more)

### Community 2 - "Website Layout & Auth"
Cohesion: 0.04
Nodes (151): UnauthorisedError(), ForbiddenError(), AboutPage(), AchievementsPage(), AgendaPage(), AgendaSection(), ApmHomepage(), CitizensSpeakForm() (+143 more)

### Community 3 - "Route Building Utilities"
Cohesion: 0.02
Nodes (150): from(), buildBranch(), buildRouteBranch(), cleanPath(), ClientOnly(), compileDecodeCharMap(), createDynamicNode(), createLRUCache() (+142 more)

### Community 4 - "APM Module Entities"
Cohesion: 0.01
Nodes (226): ApmModule, controllers, Module, ApmDataController, ApiTags, Controller, AchievementOrmEntity, Column (+218 more)

### Community 5 - "React Fiber Work Loop"
Cohesion: 0.05
Nodes (77): bailoutHooks(), bailoutOffscreenComponent(), bailoutOnAlreadyFinishedWork(), beginWork(), callComponentWillReceiveProps(), canHydrateHydrationBoundary(), canHydrateInstance(), canHydrateTextInstance() (+69 more)
...
Cohesion: 0.06
Nodes (96): invalidateApmAdmin(), useAgents(), useAgentStats(), useAllVisitStats(), useCanvassingSessions(), useCanvassingStats(), useContentAssets(), useConversionDashboard() (+88 more)

### Community 8 - "NestJS App Configuration"
Cohesion: 0.05
Nodes (65): appConfigService, databaseConfig, AuditAction(), Roles(), JwtAuthGuard, Injectable, RolesGuard, Injectable (+57 more)

### Community 9 - "App Shell Layout"
Cohesion: 0.15
Nodes (31): assignAsideVariables(), assignFooterVariables(), assignHeaderVariables(), assignNavbarVariables(), assignPaddingVariables(), getBaseSize(), getVariables(), isPrimitiveSize() (+23 more)

### Community 10 - "React Suspense & Resources"
Cohesion: 0.06
Nodes (74): accumulateSuspenseyCommitOnFiber(), acquireResource(), adoptPreloadPropsForScript(), adoptPreloadPropsForStylesheet(), attachSuspenseRetryListeners(), coerceFormActionProp(), commitHostUpdate(), commitMutationEffectsOnFiber() (+66 more)

### Community 11 - "Data Fetching Utilities"
Cohesion: 0.03
Nodes (93): AuthenticatedLayout(), isRouteAllowedForModule(), LayoutProvider(), useModuleFavicon(), allSettled(), batch(), build(), buildAttributeFields() (+85 more)

### Community 12 - "Data Page UI Components"
Cohesion: 0.05
Nodes (79): ConfirmDialog(), DebouncedTextInput(), DialogActions(), formatJson(), getDirtyPayload(), getErrorMessage(), getObject(), getOption() (+71 more)
...
Cohesion: 0.05
Nodes (53): GoodsReceiptLineOrmEntity, Column, CreateDateColumn, Entity, JoinColumn, ManyToOne, PrimaryGeneratedColumn, UpdateDateColumn (+45 more)

### Community 15 - "Auth Token Management"
Cohesion: 0.04
Nodes (70): creatorInherit(), handleNodeClick(), ack(), addEventListeners(), _addToQueue(), apply(), _cleanup(), _create() (+62 more)

### Community 16 - "APM Election & GOTV"
Cohesion: 0.17
Nodes (8): ApiOperation, Body, Delete, HttpCode, Param, Patch, Post, Put

### Community 17 - "Audit Log Controller"
Cohesion: 0.06
Nodes (38): Get, Query, Roles, CustomersController, ApiBearerAuth, ApiTags, Body, Controller (+30 more)

### Community 18 - "Sales Controller"
Cohesion: 0.14
Nodes (13): SalesListResponse, Inject, InjectRepository, CreateSaleRefundResponseDto, ApiProperty, salesConfigService, CreateSaleRefundUseCase, Injectable (+5 more)
...
Cohesion: 0.29
Nodes (38): IsDate, IsUrl, CreateArticleDto, CreateCareerDto, CreateCategoryDto, CreateHeroSlideDto, CreateInvestorDataDto, CreatePartnerDto (+30 more)

### Community 21 - "Item & Category Entities"
Cohesion: 0.05
Nodes (53): StockAdjustmentOrmEntity, Column, CreateDateColumn, Entity, JoinColumn, ManyToOne, PrimaryGeneratedColumn, StockBalanceOrmEntity (+45 more)

### Community 22 - "Purchases Controller"
Cohesion: 0.17
Nodes (20): CurrentUser, RequestUser, TenantContext, AccountingController, ApiBearerAuth, ApiTags, AuditAction, Body (+12 more)

### Community 23 - "APM Content & Tour"
Cohesion: 0.09
Nodes (21): PrintController, ApiBearerAuth, ApiOperation, ApiTags, Body, Controller, Post, UseGuards (+13 more)
...
Cohesion: 0.03
Nodes (91): accumulateOrCreateContinuousQueuedReplayableEvent(), addTrappedEventListener(), assertIsMounted(), attemptContinuousHydration(), attemptExplicitHydrationTarget(), attemptHydrationAtCurrentPriority(), attemptReplayContinuousQueuedEvent(), attemptReplayContinuousQueuedEventInMap() (+83 more)

### Community 28 - "Receivables ORM Entities"
Cohesion: 0.04
Nodes (72): PartyOrmEntity, Column, CreateDateColumn, DeleteDateColumn, Entity, PrimaryGeneratedColumn, Unique, UpdateDateColumn (+64 more)

### Community 29 - "Create Page Components"
Cohesion: 0.05
Nodes (33): GenericCreatePage(), GenericCreatePage(), ItemCreatePage(), DataPageForm(), createFormContext(), getModelConfig(), cleanNotifications(), cleanNotificationsQueue() (+25 more)
...
Cohesion: 0.08
Nodes (34): GlAccountListResponse, JournalEntryLineListResponse, JournalEntryListResponse, JournalListResponse, CreateGlAccountDto, CreateJournalDto, CreateJournalEntryDto, CreateJournalEntryLineDto (+26 more)
...
Cohesion: 0.07
Nodes (37): GlAccountOrmEntity, Column, CreateDateColumn, Entity, PrimaryGeneratedColumn, Unique, UpdateDateColumn, JournalEntryLineOrmEntity (+29 more)

### Community 36 - "Organizations Controller"
Cohesion: 0.07
Nodes (31): OrganisationsProxyService, Injectable, OrganizationsController, ApiBearerAuth, ApiTags, AuditAction, Body, Controller (+23 more)
...
Cohesion: 0.07
Nodes (47): AuditLogType, ItemSummaryType, AccountReceivableEntityType, AuditLogEntityType, CatalogItemCategoryEntityType, EntityIdRef, ItemEntityType, PartyEntityType (+39 more)

### Community 39 - "APM Admin Dashboard"
Cohesion: 0.21
Nodes (11): EhealthwaresAdminController, ApiBearerAuth, ApiTags, Controller, Get, Query, Roles, UseGuards (+3 more)

### Community 40 - "APM Election Service"
Cohesion: 0.05
Nodes (36): ApmAgentController, ApmGotvController, ApmIncidentController, ApmResultController, ApiBearerAuth, ApiOperation, ApiTags, Body (+28 more)

### Community 41 - "Auth Proxy Controller"
Cohesion: 0.13
Nodes (13): RolesProxyController, ApiBearerAuth, ApiOperation, ApiTags, Body, Controller, Delete, Get (+5 more)
...
Cohesion: 0.04
Nodes (62): interpolateTransform(), a(), Backoff(), catchall(), _check(), clone(), cloneDef(), convertBaseSchema() (+54 more)

### Community 44 - "Receivables API & Cache"
Cohesion: 0.07
Nodes (24): AccountingModule, Module, ACCOUNT_CODES, receivablesConfigService, ReceivablesModule, Module, ReceivablesRepository, ApplyReceivableAdjustmentUseCase (+16 more)

### Community 45 - "Receivable Entities"
Cohesion: 0.11
Nodes (22): AccountReceivable, ReceivableTransaction, ReceivableTransactionOrmEntity, Column, CreateDateColumn, Entity, JoinColumn, ManyToOne (+14 more)

### Community 46 - "APM Canvassing Module"
Cohesion: 0.06
Nodes (32): ApmCanvassingController, ApmSentimentController, ApmVolunteerAssignmentController, ApiBearerAuth, ApiOperation, ApiTags, Body, Controller (+24 more)

### Community 47 - "React Commit Callbacks"
Cohesion: 0.05
Nodes (80): callCallback(), captureCommitPhaseError(), checkIfRootIsPrerendering(), clearContainerSparingly(), clearHydrationBoundary(), commitActivityHydrationCallbacks(), commitBeforeMutationEffects(), commitCachePassiveMountEffect() (+72 more)
...
Cohesion: 0.09
Nodes (34): PurchasesController, ApiBearerAuth, ApiTags, AuditAction, Body, Controller, Delete, Get (+26 more)

### Community 51 - "Point of Sale Components"
Cohesion: 0.08
Nodes (39): useMantineStyleNonce(), AssignLocationModal(), _clearAcks(), onClose(), calculateTotals(), CartTable(), createSale(), CustomerQuickAddModal() (+31 more)
...
Cohesion: 0.07
Nodes (34): createIntegrationTestContext(), destroyIntegrationTestContext(), hasDbTestDeps, hasLoopbackSocketPermission, IntegrationTestContext, Repositories, seedBaseData(), SeededIds (+26 more)

### Community 54 - "Payment Methods Controller"
Cohesion: 0.08
Nodes (34): PaymentMethodsController, ApiBearerAuth, ApiTags, AuditAction, Body, Controller, Delete, Get (+26 more)

### Community 55 - "Floating UI Utilities"
Cohesion: 0.11
Nodes (39): clamp(), computeCoordsFromPlacement(), convertValueToCoords(), detectOverflow(), evaluate(), expandPaddingObject(), fn(), getAlignment() (+31 more)
...
Cohesion: 0.10
Nodes (8): SalesRepository, Inject, Optional, Inject, InjectRepository, Optional, Inject, Optional
...
Cohesion: 0.22
Nodes (14): ReceivablesController, toReceivableResponse(), ApiBearerAuth, ApiOperation, ApiTags, AuditAction, Body, Controller (+6 more)
...
Cohesion: 0.14
Nodes (16): deepMerge(), isObject(), MantineThemeProvider(), convertCssVariables(), cssVariablesObjectToString(), getColorSchemeCssVariables(), getMergedVariables(), HeadlessMantineProvider() (+8 more)
...
Cohesion: 0.07
Nodes (34): AENode(), bindKey(), calcNextPosition(), calculateXYZPosition(), clampNodeExtent(), createNodeInternals(), delay_default(), delayConstant() (+26 more)
...
Cohesion: 0.08
Nodes (22): active(), ItemCategory, Item, ItemVisibility, ForeignProperty, GenericProductResponse, ItemCategoryResponse, PharmaceuticsResponse (+14 more)

### Community 71 - "APM Public Endpoints"
Cohesion: 0.05
Nodes (42): ApmAdminController, ApiBearerAuth, ApiOperation, ApiTags, Controller, Get, Query, Roles (+34 more)
...
Cohesion: 0.06
Nodes (35): dependencies, axios, class-transformer, class-validator, cloudinary, cross-fetch, dotenv, exceljs (+27 more)
...
Cohesion: 0.06
Nodes (36): catalogConfigService, CatalogModule, Module, ItemDependencyResponse, ItemListResponse, Inject, InjectRepository, PatchItemDto (+28 more)
...
Cohesion: 0.19
Nodes (23): AccountForm(), SettingsAccount(), AppearanceForm(), SettingsAppearance(), ContentSection(), DisplayForm(), SettingsDisplay(), continuousStart() (+15 more)
...
Cohesion: 0.05
Nodes (42): ClassificationOrmEntity, Column, CreateDateColumn, DeleteDateColumn, Entity, PrimaryGeneratedColumn, Unique, UpdateDateColumn (+34 more)
...
Cohesion: 0.17
Nodes (10): Column, CreateDateColumn, Entity, OneToMany, PrimaryGeneratedColumn, Unique, UpdateDateColumn, WarehouseOrmEntity (+2 more)

### Community 85 - "Mantine Theme Utilities"
Cohesion: 0.03
Nodes (47): UomEditRoute(), DataPageShell(), FormProvider(), getValueByPath(), name(), renderCell(), renderCellValue(), RxAuditLogsPage() (+39 more)

### Community 86 - "DOM Positioning Utilities"
Cohesion: 0.26
Nodes (18): getClippingElementAncestors(), getClippingRect(), getComputedStyle$1(), getContainingBlock(), getFrameElement(), getNearestOverflowAncestor(), getNodeName(), getOffsetParent() (+10 more)

### Community 87 - "Questionnaire & Conversation UI"
Cohesion: 0.18
Nodes (9): ListSalesDto, ApiPropertyOptional, IsIn, IsInt, IsOptional, IsString, Max, Min (+1 more)

### Community 88 - "Items Controller"
Cohesion: 0.11
Nodes (28): ItemsController, ApiBearerAuth, ApiOperation, ApiResponse, ApiTags, AuditAction, Body, Controller (+20 more)

### Community 89 - "Inventory & Stock Management"
Cohesion: 0.03
Nodes (113): aborted(), accumulateEnterLeaveListenersForEvent(), accumulateTwoPhaseListeners(), add(), attachPingListener(), attemptEarlyBailoutIfNoScheduledUpdate(), batchedUpdates$1(), cloneObject() (+105 more)
...
Cohesion: 0.20
Nodes (3): ApiOperation, Get, Param

### Community 92 - "Achievement & Agenda Schemas"
Cohesion: 0.67
Nodes (3): AchievementSchema, Prop, Schema

### Community 93 - "Candidate Tour Schemas"
Cohesion: 0.07
Nodes (33): CandidateTourDocument, CandidateTourSchema, CandidateTourSchemaFactory, Prop, Schema, ContentAssetDocument, ContentAssetSchema, ContentAssetSchemaFactory (+25 more)

### Community 94 - "UOM Category Entity"
Cohesion: 0.31
Nodes (4): getEffectiveFactor(), Injectable, InjectRepository, UomConverterService
...
Cohesion: 0.07
Nodes (26): CanvassingSessionDocument, CanvassingSessionSchema, CanvassingSessionSchemaFactory, Prop, Schema, CanvassingVisitDocument, CanvassingVisitSchema, CanvassingVisitSchemaFactory (+18 more)

### Community 98 - "Delivery & Order Entities"
Cohesion: 0.08
Nodes (31): ORDER_STATUS_TRANSITIONS, DeliveryOrmEntity, Column, CreateDateColumn, Entity, JoinColumn, OneToOne, PrimaryGeneratedColumn (+23 more)
...
Cohesion: 0.10
Nodes (17): StockAdjustment, ItemReference, StockLocationReference, StockLotReference, InventoryMapper, InMemoryInventoryRepository, Injectable, AdjustStockByReferencePayload (+9 more)
...
Cohesion: 0.19
Nodes (24): autoUpdate(), convertOffsetParentRelativeRectToViewportRelativeRect(), getBoundingClientRect(), getClientRectFromClippingAncestor(), getCssDimensions(), getDocumentElement(), getDocumentRect(), getHTMLOffset() (+16 more)
...
### Community 107 - "APM Conversion Service"
Cohesion: 0.22
Nodes (10): contains(), createAttribute(), getNodeChildren(), getTarget(), hasWindow(), isEventTargetWithin(), isReactEvent(), isRootElement() (+2 more)

### Community 108 - "Generic Drug Cache Service"
Cohesion: 0.09
Nodes (13): ListGenericProductsDto, GenericProductsService, toGenericProductType(), Injectable, Inject, GenericDrugCacheService, Injectable, CachedGenericProduct (+5 more)
...
Cohesion: 0.20
Nodes (7): ApiOperation, AuditAction, Body, Get, Post, Query, Roles

### Community 113 - "Goods Receipt Controller"
Cohesion: 0.23
Nodes (13): InflowController, ApiBearerAuth, ApiOperation, ApiTags, AuditAction, Body, Controller, Get (+5 more)
...
Cohesion: 0.11
Nodes (25): InventoryController, mapBalance(), ApiBearerAuth, ApiOperation, ApiTags, AuditAction, Body, Controller (+17 more)
...
Cohesion: 0.11
Nodes (19): Inject, GoodsReceiptLineResponseDto, GoodsReceiptResponseDto, ReceiveGoodsDto, ReceiveGoodsLineDto, ApiProperty, ApiPropertyOptional, IsArray (+11 more)
...
Cohesion: 0.06
Nodes (33): AchievementDocument, AchievementSchemaFactory, ConversionActivityDocument, ConversionActivitySchema, ConversionActivitySchemaFactory, Prop, Schema, ConversionScoreDocument (+25 more)

### Community 126 - "Gotv & Incident Schemas"
Cohesion: 0.08
Nodes (21): GotvRecordDocument, GotvRecordSchema, GotvRecordSchemaFactory, Prop, Schema, IncidentReportDocument, IncidentReportSchema, IncidentReportSchemaFactory (+13 more)
...
Cohesion: 0.09
Nodes (20): CreateStockAdjustmentDto, ApiProperty, IsNotEmpty, IsNumber, IsString, CreateStockTransferDto, ApiProperty, IsNotEmpty (+12 more)

### Community 129 - "User POS Config"
Cohesion: 0.11
Nodes (18): ApiBearerAuth, ApiTags, Body, Controller, Get, Patch, Roles, UseGuards (+10 more)
...
Cohesion: 0.12
Nodes (16): InjectEntityManager, RelationId, Column, CreateDateColumn, Entity, JoinColumn, ManyToOne, PrimaryGeneratedColumn (+8 more)
...
Cohesion: 0.33
Nodes (7): IsObject, ReconcileAllDto, ReconcileItemDto, IsNotEmpty, IsOptional, IsString, IsUUID

### Community 138 - "Inventory Repository Implementations"
Cohesion: 0.05
Nodes (71): InjectModel, Article, ArticleDocument, ArticleSchema, Prop, Schema, Career, CareerDocument (+63 more)
...
Cohesion: 0.29
Nodes (6): CreateSupplierDto, ApiProperty, ApiPropertyOptional, IsEmail, IsOptional, IsString
...
Cohesion: 0.06
Nodes (33): ApmContentController, ApmListeningController, ApmTourController, ApmTruthDeskController, ApiBearerAuth, ApiOperation, ApiTags, Body (+25 more)
...
Cohesion: 0.19
Nodes (22): CartItemRow(), CartPage(), cartSubtotal(), formatPrice(), getMockPrice(), getProductDosage(), getProductGeneric(), getProductName() (+14 more)
...
Cohesion: 0.11
Nodes (24): GenericProductsController, ApiBearerAuth, ApiOperation, ApiTags, AuditAction, Body, Controller, Get (+16 more)
...
Cohesion: 0.38
Nodes (5): CreateSaleResponseDto, ApiProperty, SaleResponseDto, ApiProperty, ApiPropertyOptional

### Community 160 - "Stock Movement List DTO"
Cohesion: 0.13
Nodes (21): AppSidebar(), AutoLogout(), filterNavGroupsByModule(), getModuleDashboard(), NavUser(), SignOutDialog(), TeamSwitcher(), toTeams() (+13 more)
...
Cohesion: 0.20
Nodes (14): SalesController, ApiBearerAuth, ApiOperation, ApiResponse, ApiTags, AuditAction, Body, Controller (+6 more)
...
Cohesion: 0.06
Nodes (62): advanceTimers(), bubbleProperties(), checkForUnmatchedText(), claimNextRetryLane(), compare(), completeUnitOfWork(), completeWork(), createCapturedValueAtFiber() (+54 more)

### Community 178 - "APM Controllers"
Cohesion: 0.05
Nodes (34): ApmConversionController, ApmStakeholderController, ApmWhatsAppController, ApiBearerAuth, ApiOperation, ApiTags, Body, Controller (+26 more)

### Community 179 - "Update Org Config DTO"
Cohesion: 0.12
Nodes (16): OrderAdminController, ApiBearerAuth, ApiOperation, ApiQuery, ApiTags, Body, Controller, Get (+8 more)

### Community 180 - "ehealthwares.service.ts"
Cohesion: 0.14
Nodes (14): CreateContactDto, GetBySlugDto, ListQueryDto, ApiProperty, ApiPropertyOptional, IsEmail, IsInt, IsNotEmpty (+6 more)
...
Cohesion: 0.07
Nodes (20): CacheModule, Global, Module, AppCacheService, Injectable, ReplaceItemDto, ApiProperty, ApiPropertyOptional (+12 more)
...
Cohesion: 0.11
Nodes (11): EhealthwaresController, ApiOperation, ApiTags, Body, Controller, Get, Headers, Param (+3 more)
...
Cohesion: 0.08
Nodes (22): ReceivableMutationResponse, ReceivablesListResponse, ReceivableTransactionsListResponse, toTransactionResponse(), ListReceivablesDto, ApiPropertyOptional, IsIn, IsInt (+14 more)
...
Cohesion: 0.67
Nodes (3): PollingUnitSchema, Prop, Schema
...
Cohesion: 0.10
Nodes (15): InjectRepository, AuthProxyController, ApiBearerAuth, ApiOperation, ApiTags, Body, Controller, Get (+7 more)

### Community 211 - "Constructor Injection"
Cohesion: 0.67
Nodes (3): StakeholderSchema, Prop, Schema

### Community 248 - "orders.service.spec.ts"
Cohesion: 0.13
Nodes (13): deliveryRepo, itemRepo, orderItemRepo, orderRepo, organisationsProxy, orgItemRepo, partyRepo, pricingService (+5 more)
...
Cohesion: 0.11
Nodes (22): Column, CreateDateColumn, Entity, OneToMany, PrimaryGeneratedColumn, Unique, UpdateDateColumn, UomCategoryOrmEntity (+14 more)

### Community 255 - "AuditController"
Cohesion: 0.13
Nodes (12): AuditController, ApiBearerAuth, ApiTags, Controller, UseGuards, AuditLog, AuditLogOrmEntity, Column (+4 more)

### Community 256 - "ListReceivableTransactionsDto"
Cohesion: 0.11
Nodes (12): ListReceivableTransactionsDto, ApiPropertyOptional, IsIn, IsInt, IsOptional, Max, Min, Type (+4 more)
...
## Knowledge Gaps
- **396 isolated node(s):** `@opencode-ai/plugin`, `$schema`, `collection`, `sourceRoot`, `deleteOutDir` (+391 more)
...
- **Why does `GenericDrugCacheService` connect `Generic Drug Cache Service` to `URL Parameter Normalization`, `Branch & Consultation Entities`, `Catalog Module & Items`, `In-Memory Cache Store`, `Website Admin & DTOs`?**
  _High betweenness centrality (0.148) - this node is a cross-community bridge._
- **Why does `RequestUser` connect `Purchases Controller` to `User POS Config`, `NestJS Controller Decorators`, `NestJS App Configuration`, `Audit Log Controller`, `Organisation Config Controller`, `Sales Controller`, `Coding Concept Pages`, `Stock Locations Controller`, `Accounting Controller`, `Pricing Controller`, `Generic Products CRUD`, `Stock Balance List DTO`, `Categories Controller`, `Manufacturers Controller`, `NestJS Common Decorators`, `Warehouse Controller & Entity`, `Purchases DTOs`, `Update Org Config DTO`, `Payment Methods Controller`, `Website Admin & DTOs`, `Drug Components Controller`, `Receivables Operations`, `Audit Module`, `Stock Adjustment DTO`, `NestJS Decorators`, `Catalog Module & Items`, `APM ORM Entities`, `Items Controller`, `Suppliers CRUD Controller`, `Goods Receipt Controller`, `Inventory Controller`, `NestJS Common Decorators`?**
...
- **Should `URL Parameter Normalization` be split into smaller, more focused modules?**
  _Cohesion score 0.005677335519700509 - nodes in this community are weakly interconnected._
- **Should `UI Component Library` be split into smaller, more focused modules?**
  _Cohesion score 0.02312197919226673 - nodes in this community are weakly interconnected._