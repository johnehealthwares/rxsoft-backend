...
import { o as Loader } from "./select-D0Rn_P4j.js";
import { Pr as useNavigate, Qt as FieldGroup, Yt as RxPage, Zt as TabGroups } from "./index-DuM1cidb.js";
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Stack, {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Stack, {
					gap: "xl",
					children: tabGroups ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabGroups, {
						tabGroups,
						formState,
						updateField,
						onSubmit: () => mutation.mutate(formState),
						isPending: mutation.isPending
					}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [fieldGroups.map((fieldGroup, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FieldGroup, {
						index,
						fieldGroup,
						formState,
						updateField
					}, index)), renderCreateExtras?.({
						formState,
						updateField
					})] })
				}),
				!isWizard && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Group, {
					justify: "flex-end",
