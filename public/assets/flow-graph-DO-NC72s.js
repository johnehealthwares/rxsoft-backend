...
import { t as require_with_selector } from "./with-selector-BBDBb_br.js";
import { t as communicationApi } from "./communication-api-Cd2UxqAK.js";
import { Yt as RxPage } from "./index-DwQ-NyPQ.js";
...
var Handle = (0, import_react.forwardRef)(({ type = "source", position = Position.Top, isValidConnection, isConnectable = true, isConnectableStart = true, isConnectableEnd = true, id, onConnect, children, className, onMouseDown, onTouchStart, ...rest }, ref) => {
	...
	const { connectOnClick, noPanClassName } = useStore(selector$f, shallow$1$3);
	const { connecting, clickConnecting } = useStore(connectingSelector(nodeId, handleId, type), shallow$1$3);
...
function areEqual(a, b) {
	return shallow$1$3(a.selectedNodes.map(selectId), b.selectedNodes.map(selectId)) && shallow$1$3(a.selectedEdges.map(selectId), b.selectedEdges.map(selectId));
}
...
var StoreUpdater = ({ nodes, edges, defaultNodes, defaultEdges, onConnect, onConnectStart, onConnectEnd, onClickConnectStart, onClickConnectEnd, nodesDraggable, nodesConnectable, nodesFocusable, edgesFocusable, edgesUpdatable, elevateNodesOnSelect, minZoom, maxZoom, nodeExtent, onNodesChange, onEdgesChange, elementsSelectable, connectionMode, snapGrid, snapToGrid, translateExtent, connectOnClick, defaultEdgeOptions, fitView, fitViewOptions, onNodesDelete, onEdgesDelete, onNodeDrag, onNodeDragStart, onNodeDragStop, onSelectionDrag, onSelectionDragStart, onSelectionDragStop, noPanClassName, nodeOrigin, rfId, autoPanOnConnect, autoPanOnNodeDrag, onError, connectionRadius, isValidConnection, nodeDragThreshold }) => {
	const { setNodes, setEdges, setDefaultNodesAndEdges, setMinZoom, setMaxZoom, setTranslateExtent, setNodeExtent, reset } = useStore(selector$d, shallow$1$3);
	const store = useStoreApi();
	(0, import_react.useEffect)(() => {
...
var useViewportHelper = () => {
	const store = useStoreApi();
	const { d3Zoom, d3Selection } = useStore(selector$b, shallow$1$3);
	return (0, import_react.useMemo)(() => {
...
var ZoomPane = ({ onMove, onMoveStart, onMoveEnd, onPaneContextMenu, zoomOnScroll = true, zoomOnPinch = true, panOnScroll = false, panOnScrollSpeed = .5, panOnScrollMode = PanOnScrollMode.Free, zoomOnDoubleClick = true, elementsSelectable, panOnDrag = true, defaultViewport, translateExtent, minZoom, maxZoom, zoomActivationKeyCode, preventScrolling = true, children, noWheelClassName, noPanClassName }) => {
	...
	const { d3Zoom, d3Selection, d3ZoomHandler, userSelectionActive } = useStore(selector$a, shallow$1$3);
...
function UserSelection() {
	const { userSelectionActive, userSelectionRect } = useStore(selector$9, shallow$1$3);
...
var Pane = (0, import_react.memo)(({ isSelecting, selectionMode = SelectionMode.Full, panOnDrag, onSelectionStart, onSelectionEnd, onPaneClick, onPaneContextMenu, onPaneScroll, onPaneMouseEnter, onPaneMouseMove, onPaneMouseLeave, children }) => {
	...
	const { userSelectionActive, elementsSelectable, dragging } = useStore(selector$8, shallow$1$3);
...
function NodesSelection({ onSelectionContextMenu, noPanClassName, disableKeyboardA11y }) {
	const store = useStoreApi();
	const { width, height, x: left, y: top, transformString, userSelectionActive } = useStore(selector$7, shallow$1$3);
	const updatePositions = useUpdateNodePositions();
	const nodeRef = (0, import_react.useRef)(null);
	(0, import_react.useEffect)(() => {
...
var NodeRenderer = (props) => {
	const { nodesDraggable, nodesConnectable, nodesFocusable, elementsSelectable, updateNodeDimensions, onError } = useStore(selector$5, shallow$1$3);
...
var EdgeRenderer = ({ defaultMarkerColor, onlyRenderVisibleElements, elevateEdgesOnSelect, rfId, edgeTypes, noPanClassName, onEdgeContextMenu, onEdgeMouseEnter, onEdgeMouseMove, onEdgeMouseLeave, onEdgeClick, onEdgeDoubleClick, onReconnect, onReconnectStart, onReconnectEnd, reconnectRadius, children, disableKeyboardA11y }) => {
	const { edgesFocusable, edgesUpdatable, elementsSelectable, width, height, connectionMode, nodeInternals, onError } = useStore(selector$4, shallow$1$3);
...
function ConnectionLineWrapper({ containerStyle, style, type, component }) {
	const { nodeId, handleType, nodesConnectable, width, height, connectionStatus } = useStore(selector$2$1, shallow$1$3);
...
function MiniMapNodes({ nodeStrokeColor = "transparent", nodeColor = "#e2e2e2", nodeClassName = "", nodeBorderRadius = 5, nodeStrokeWidth = 2, nodeComponent: NodeComponent = MiniMapNode$1, onClick }) {
	const nodes = useStore(selectorNodes, shallow$1$2);
...
function MiniMap({ style, className, nodeStrokeColor = "transparent", nodeColor = "#e2e2e2", nodeClassName = "", nodeBorderRadius = 5, nodeStrokeWidth = 2, nodeComponent, maskColor = "rgb(240, 240, 240, 0.6)", maskStrokeColor = "none", maskStrokeWidth = 1, position = "bottom-right", onClick, onNodeClick, pannable = false, zoomable = false, ariaLabel = "React Flow mini map", inversePan = false, zoomStep = 10, offsetScale = 5 }) {
	...
	const { boundingRect, viewBB, rfId } = useStore(selector$2, shallow$1$2);
...
//#endregion
//#region src/features/communication/pages/graph-view.tsx
...
var sampleTopology = {
	...
	validationRules: [{
		id: "v1",
		name: "DICOM Validation",
		action: { module: "DICOM" }
	}, {
		id: "v2",
		name: "LOINC Validation",
		action: { module: "LOINC" }
	}]
};
function AENode({ data }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, {
				size: "xs",
				c: "dimmed",
				children: data.facilityName
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Divider, { my: 6 }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Group, {
				gap: 6,
				children: data.protocols?.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
					size: "xs",
					variant: "light",
					children: p
				}, p))
...
function GraphViewPage() {
	const { data, isLoading, isError } = useQuery({
		...
		queryFn: async () => {
			return (await communicationApi.get("/flow/topology")).data;
		},
		retry: false
	});
	const topology = (0, import_react.useMemo)(() => data ?? sampleTopology, [data]);
	const nodes = (0, import_react.useMemo)(() => {
		return topology.applicationEntities?.map((ae, index) => ({
			id: ae.id,
			position: {
				x: index * 250,
				y: 150
	...
	const edges = (0, import_react.useMemo)(() => {
		return (topology.routingTables?.[0]?.routes ?? []).map((r) => ({
			id: r.name,
			source: r.sourceAE,
			target: r.targetAE,
			label: r.protocol,
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Stack, {
								gap: "xs",
								mt: "sm",
								children: topology.applicationEntities?.map((n) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
									withBorder: true,
									p: "xs",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, {
										size: "sm",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, {
							...
							gap: "xs",
							mt: "sm",
							children: topology.routingTables?.[0]?.routes?.map((r) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
								withBorder: true,
								p: "xs",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, {
									size: "sm",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, {
							...
							gap: "xs",
							mt: "sm",
							children: topology.validationRules?.map((v) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
								withBorder: true,
								p: "xs",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, {
									size: "sm",
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ReactFlow, {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Controls$1, {})
						]
					}),
					isLoading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, {
						size: "sm",
						c: "dimmed",
						children: "Loading topology…"
					}),
					isError && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, {
						size: "sm",
						c: "red",
						children: "Failed to load live topology (showing sample)"
					})
				]
			})]
		})
...
//#endregion
//#region src/routes/_authenticated/communication/flow-graph.tsx?tsr-split=component
var SplitComponent = GraphViewPage;
//#endregion
