...
import { D as AuthLayout, Lr as Title, Vr as PasswordInput } from "./index-DuM1cidb.js";
...
//#endregion
//#region src/features/auth/sign-up/components/sign-up-form.tsx
	...
	const form = useForm({
		...
		validate: {
			...
			confirmPassword: (value, values) => {
				...
				if (value !== values.password) return "Passwords don't match";
				return null;
			}
		}
	});
...
//#endregion
//#region src/features/auth/sign-up/pages/sign-up-page.tsx
function SignUp() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthLayout, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
		withBorder: true,
		shadow: "sm",
		radius: "md",
		padding: "lg",
