...
function randomDatePastYear(): Date {
  const now = new Date();
...
function generateMedicationContent(title: string): string {
...
function generateConditionContent(title: string): string {
...
function generateWellnessContent(title: string): string {
...
function generateWomenHealthContent(title: string): string {
...
function generateChildrenHealthContent(title: string): string {
...
function generateFirstAidContent(title: string): string {
...
function buildArticle(article: ArticleDefinition): Partial<BlogArticleOrmEntity> {
...
export async function seedBlogArticles(manager: EntityManager): Promise<void> {
  const repo = manager.getRepository(BlogArticleOrmEntity);
