...
import type { ProductCategoryOrmEntity as CatalogProductCategoryOrmEntity } from '../../modules/catalog/entities/product-category.orm-entity';
import type { ProductOrmEntity } from '../../modules/catalog/entities/product.orm-entity';
import type { ProductCategoryOrmEntity as CategoriesProductCategoryOrmEntity } from '../../modules/categories/entities/product-category.orm-entity';
...
export type CatalogProductCategoryEntityType = SerializedEntity<CatalogProductCategoryOrmEntity>;
export type ProductEntityType = SerializedEntity<ProductOrmEntity>;
export type CategoriesProductCategoryEntityType = SerializedEntity<CategoriesProductCategoryOrmEntity>;
